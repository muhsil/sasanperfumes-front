    ...
    <div className="flex flex-wrap items-center justify-center gap-4">
      {whatsappNumber && (
        <a
          ...
          className="group flex items-center gap-3 rounded-full bg-gradient-to-r from-brand-primary to-brand-primary px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-brand-primary/20 transition-all duration-300 hover:from-brand-primary hover:to-brand-primary-dark hover:shadow-xl hover:shadow-brand-primary/30"
        >
