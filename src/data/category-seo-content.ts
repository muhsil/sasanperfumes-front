...
const CATEGORY_FOCUS: Record<string, { en: string; ar: string }> = {
  ...
  "new-products-ar": { en: "new perfume products and fresh arrivals from Sasan Perfumes", ar: "منتجات عطرية جديدة وأحدث الإصدارات من ساسان للعطور" },
  "extrait-de-parfum-ar": { en: "extrait de parfum scents with a richer, more concentrated finish", ar: "عطور إكستريت دو بارفوم بتركيبة أكثر تركيزًا وفخامة" },
  "perfume-ar": { en: "everyday perfume favorites and signature scents", ar: "عطور يومية مفضلة ونغمات عطرية مميزة" },
  ...
  "perfumes-ar": { en: "premium, long-lasting perfumes for women and men", ar: "عطور فاخرة وثابتة للنساء والرجال" },
