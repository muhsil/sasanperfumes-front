...
export const siteConfig = {
  ...
  description: "Premium perfumes, oud, hair mist, and gift sets from Sasan Perfumes Dubai. Shop in AED with fast delivery across Dubai, the UAE, and international markets. A 60+ year fragrance heritage brand blending tradition with modern elegance.",
