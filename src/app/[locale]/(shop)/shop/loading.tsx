...
function CollectionHeaderLoading() {
  return (
    <section className="section-band text-brand-primary">
      ...
      <div className="flex flex-col gap-6 px-4 py-8 md:flex-row md:items-center md:gap-8 md:pb-8 lg:gap-12">
...
function ProductToolbarLoading() {
  return (
    <div className="section-band relative flex items-center justify-between gap-4 px-4 py-3 text-brand-primary">
