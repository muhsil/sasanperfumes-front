...
const defaultSeo = {
  ...
  description: {
    ...
    ar: "أنشئ مجموعة عطور فريدة من اختيارك. اختر 3 منتجات أو أكثر من العطور والزيوت واللوشن ومعطرات المنزل. هدية مثالية من ShapeHive. توصيل مجاني للطلبات فوق 500 درهم.",
  },
  keywords: {
