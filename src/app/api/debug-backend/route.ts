...
export async function GET() {
  ...
  const results = await Promise.all([
    ...
    testHomeSettings("17_home_settings_main_qa_subdomain", `${BASE}/wp-json/sasanperfumes/v1/home-settings?lang=en&frontend_host=qa.sasanperfumes.com&_t=${Date.now()}`, homeHeaders),
    testHomeSettings("18_home_settings_main_qa_subdomain_https", `${BASE}/wp-json/sasanperfumes/v1/home-settings?lang=en&frontend_host=https%3A%2F%2Fqa.sasanperfumes.com&_t=${Date.now()}`, homeHeaders),
    testHomeSettings("19_home_settings_main_qa_subdomain_with_market", `${BASE}/wp-json/sasanperfumes/v1/home-settings?lang=en&market=qa&frontend_host=qa.sasanperfumes.com&_t=${Date.now()}`, homeHeaders),
    testHomeSettings("20_home_settings_main_qa_header", `${BASE}/wp-json/sasanperfumes/v1/home-settings?lang=en&_t=${Date.now()}`, {
      ...homeHeaders,
      "X-Frontend-Host": "qa.sasanperfumes.com",
      "X-Market": "qa",
    }),
