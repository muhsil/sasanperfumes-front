...
export async function GET() {
  ...
  const results = await Promise.all([
    ...
    testHomeSettings("16_home_settings_qa_with_frontend_host", `${BASE}/qa/wp-json/sasanperfumes/v1/home-settings?lang=en&frontend_host=sasanperfumes.com%2Fqa&_t=${Date.now()}`, homeHeaders),
    testHomeSettings("17_home_settings_main_qa_frontend_host", `${BASE}/wp-json/sasanperfumes/v1/home-settings?lang=en&frontend_host=sasanperfumes.com%2Fqa&_t=${Date.now()}`, homeHeaders),
    testHomeSettings("18_home_settings_main_qa_frontend_host_https", `${BASE}/wp-json/sasanperfumes/v1/home-settings?lang=en&frontend_host=https%3A%2F%2Fsasanperfumes.com%2Fqa&_t=${Date.now()}`, homeHeaders),
    testHomeSettings("19_home_settings_main_qa_with_market", `${BASE}/wp-json/sasanperfumes/v1/home-settings?lang=en&market=qa&frontend_host=sasanperfumes.com%2Fqa&_t=${Date.now()}`, homeHeaders),
    testHomeSettings("20_home_settings_main_qa_header", `${BASE}/wp-json/sasanperfumes/v1/home-settings?lang=en&_t=${Date.now()}`, {
      ...homeHeaders,
      "X-Frontend-Host": "sasanperfumes.com/qa",
      "X-Market": "qa",
    }),
